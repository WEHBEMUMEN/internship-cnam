...
- [x] Create project Gantt chart and deploy GitHub Pages site.
- [ ] Set up literature review catalog.
- [ ] Read the primary paper on Isogeometric Analysis (Cottrell et al., 2009).
- [ ] Review the "Shared resources Mumen" link.

### 🤝 Supervisor Meeting Notes (Date: YYYY-MM-DD)
* **Questions to ask:**
  1. What specific parameters should be adjustable in real-time?
  2. Should the initial 2D test case be a specific mechanical component (e.g., a beam or plate)?
* **Notes/Answers:**
